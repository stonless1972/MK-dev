...
if __name__=='__main__':
    ...
    ivpsc_hard=False
    if args.fnpickle_vpsc_hard is not None:
        ivpsc_hard=True
    ...
    for ihrd in range(nfs): ## type of hardening function
        if not(ivpsc_hard):
        ...
        for ieps in range(neps_eq):
            for iyld in range(nyfs): ## type of yield function
